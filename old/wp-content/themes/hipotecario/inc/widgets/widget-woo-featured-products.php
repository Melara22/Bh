...
class stag_widget_featured_product extends WP_Widget{
	...
	function widget( $args, $instance ) {
		...
		(function($){
			...
			jQuery('#featured-product-slider-<?php echo $slider_id ?> .featured-product-slider').slick({
			  dots: false,
			  infinite: false,
			  speed: 300,
			  slidesToShow: 3,
		...
		<div id="featured-product-slider-<?php echo $slider_id ?>" class="featured-product-slider-wrapper clearfix">
			<div class="inside">

				<div class="featured-product-header clearfix">
					<?php echo $before_title . $title . $after_title; ?>
				</div>

				<div class="product-slider-item-wrapper">

					<div class="featured-product-slider clearfix">
						<?php
