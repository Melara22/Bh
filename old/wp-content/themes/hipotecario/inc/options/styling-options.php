...
function stag_custom_css( $content ) {
	...
	if ( $accent != '' ) {
		...
		$content .= ".ls-yttor .ls-bar-timer, .ls-yttor .ls-nav-prev:hover, .ls-yttor .ls-nav-next:hover, .ls-yttor .ls-nav-stop-active, .ls-yttor .ls-nav-start-active { background: {$accent} !important; }\n";
	}
