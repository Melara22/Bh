...
if( $mostrar_hslider == 1)
{
	...
	<div id="homeslider" class="row no-margin no-padding">
		...
		{
			?>
			<div class="single-home-slide" style=" background-image: url(<?php echo $main_slider[$s]["imagen"]; ?>); ">
				<img src="<?php echo $main_slider[$s]["imagen"];?>" class="img-responsive center-block w100 hidden">
				<div class=" overlay ">
