...
function stag_scripts_styles(){
	...
	wp_enqueue_script('boostrapjs', get_template_directory_uri().'/assets/bootstrap/js/bootstrap.js', array('jquery'), '', true  );

	/*Images loaded*/
	wp_enqueue_script('jquery.imagesloaded.min', get_template_directory_uri().'/assets/js/imagesloaded.pkgd.min.js', array('jquery'), '', true  );
	/*END*/

	//Google Maps
	wp_enqueue_script( 'google-maps-js', 'https://maps.google.com/maps/api/js?sensor=false&key=AIzaSyAGs1RzRvtzmhwRdETTMo6Zj5JUeob_62Q&#038;ver=4.2.5');


    /*FANCYBOX version anterior 

    wp_enqueue_script('jquery.mousewheel', get_template_directory_uri().'/assets/js/jquery.mousewheel-3.0.6.pack.js', array('jquery'), '', true  );
    wp_enqueue_script('jquery.fancybox', get_template_directory_uri().'/assets/js/fancybox/jquery.fancybox.js?v=2.1.5', array('jquery'), '', true  );
	wp_enqueue_style( 'fancybox.css', get_template_directory_uri(). '/assets/css/fancybox/jquery.fancybox.css?v=2.1.5', array(), null );
	wp_enqueue_style( 'helpers.buttons.css', get_template_directory_uri(). '/assets/js/fancybox/helpers/jquery.fancybox-buttons.css?v=1.0.5', array(), null );
	wp_enqueue_script('jquery.fancybox.buttons-js', get_template_directory_uri().'/assets/js/fancybox/helpers/jquery.fancybox-buttons.js?v=1.0.5', array('jquery'), '', true  );
	wp_enqueue_style( 'jquery.fancybox-thumbs.css', get_template_directory_uri(). '/assets/js/fancybox/helpers/jquery.fancybox-thumbs.css?v=1.0.7', array(), null );
	wp_enqueue_script('jquery.fancybox-thumbs', get_template_directory_uri().'/assets/js/fancybox/helpers/jquery.fancybox-thumbs.js?v=1.0.7', array('jquery'), '', true  );
	wp_enqueue_script('jquery.fancybox-media', get_template_directory_uri().'/assets/js/fancybox/helpers/jquery.fancybox-media.js?v=1.0.6', array('jquery'), '', true  );
    
    end fancybox */

    wp_enqueue_style( 'fancybox-css', get_template_directory_uri(). '/assets/fancybox3/jquery.fancybox.min.css', array(), time(), null );
    wp_enqueue_script('fancybox-js', get_template_directory_uri().'/assets/fancybox3/jquery.fancybox.min.js', array('jquery'), '', true  );

    //isotope
    wp_enqueue_script( 'isotope', get_template_directory_uri().'/assets/js/isotope.pkgd.min.js', array('jquery'), time(), true );


    wp_enqueue_style( 'animate_css', get_template_directory_uri(). '/assets/css/animate.css', array(), time(), null );


    wp_enqueue_style( 'sweetalert', get_template_directory_uri()."/assets/css/sweetalert.css" );
    wp_enqueue_script('jquery.sweetalert.min', get_template_directory_uri().'/assets/js/sweetalert.min.js', array('jquery'), '', true  );
    

    /*SLICK*/
	wp_enqueue_style( 'slick_css', get_template_directory_uri(). '/assets/css/slick/slick.css', array(), time(), null );
	wp_enqueue_style( 'slick_theme_css', get_template_directory_uri(). '/assets/css/slick/slick-theme.css', array(), time(), null );
	wp_enqueue_script('jquery.slick', get_template_directory_uri().'/assets/js/slick/slick.js', array('jquery'), time(), true  );
    /*end*/

    wp_enqueue_style( 'datepicker-css', get_template_directory_uri(). '/assets/datepicker/css/bootstrap-datepicker.css', array(), time(), null );
	wp_enqueue_script('datepickerjs', get_template_directory_uri().'/assets/datepicker/js/bootstrap-datepicker.js', array('jquery'), time(), true  );



    //wp_enqueue_script('datepicker', get_template_directory_uri().'/assets/js/bootstrap-datepicker.js', array('jquery'), time(), true  );
    wp_enqueue_script('jquery.wow', get_template_directory_uri().'/assets/js/wow.js', array('jquery'), time(), true  );
    wp_enqueue_script('jquery.masonry', get_template_directory_uri().'/assets/js/masonry.pkgd.min.js', array('jquery'), time(), true  );
    wp_enqueue_script('jquery.animatescroll', get_template_directory_uri().'/assets/js/animatescroll.js', array('jquery'), time(), true  );

    //jvalidate
    wp_enqueue_script( 'jvalidate', get_template_directory_uri().'/assets/js/jquery.validate.min.js', array('jquery'), time(), true );
    
    wp_enqueue_script('jquery.sticky', get_template_directory_uri().'/assets/js/jquery.sticky.js', array('jquery'), time(), true  );

    wp_enqueue_script('jquery.parallax', get_template_directory_uri().'/assets/js/jquery.stellar.min.js', array('jquery'), time(), true  );

    //wp_enqueue_script('tubular', get_template_directory_uri().'/assets/js/jquery.tubular.1.0.js', array('jquery'), time(), true  );

    wp_enqueue_script('youtubebackground', get_template_directory_uri().'/assets/js/jquery.youtubebackground.js', array('jquery'), time(), true  );

    wp_enqueue_script('jquery.settings', get_template_directory_uri().'/assets/js/settings.js', array('jquery'), time(), true  );

    wp_localize_script( 'jquery.settings', 'mycustomurl', array( 
		'my_ajax_url' => admin_url('admin-ajax.php')
	) );

	wp_localize_script( 'jquery.settings', 'urlwebsite', array( 
		'urldirectory' => get_template_directory_uri()
	) );
	...
	if ( stag_is_woocommerce_active() ) $dependencies[] = 'yttor-woocommerce';
 ...
 */
/*
if ( ! function_exists( 'yttor_custom_css' ) ) :
function yttor_custom_css() {
	ob_start();
...
add_action( 'wp_head', 'yttor_custom_css', 10 );
*/
