...
?>
        ...
        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 product overflow-hidden margin-topbottom-20"  ><?php //post_class( $classes ); ?>
            ...
            <div class="clearfix border-eaeaea padding-10 ">
            	...
            	<div class="thumbnail-container">
            	    ...
            	    <a href="<?php the_permalink(); ?>">
                                ...
                                <?PHP   
                                      ...
                                      echo "<img src='".$thumb[0]."' class='img-responsive margin-auto' />";
                                ?>
            	...
            	<div class="product-info <?php echo $rating_status; ?>">
                  ...
                  <a href="<?php echo get_permalink(get_the_ID()) ?>" class="btn btn-warning btn-block btn-lg"><?php _e( 'Details', 'stag' ); ?></a>
                  <?php endif ?>
