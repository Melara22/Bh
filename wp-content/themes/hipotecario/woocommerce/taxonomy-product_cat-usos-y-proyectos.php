...
get_header(); ?>
	...
	<section id="primary" class="content-area">
		...
		<?php if ( have_posts() ) : ?>
			...
			$topcatid = pa_category_top_parent_id($tax->term_id);
			echo "<p>TOPID: ".$topcatid."</p>";

			$term_id       = get_term_by( 'slug', $topcatid, 'product_cat' );
			...
			<div class="customcontainer subcatcontainer">
			<?php
			...
			if( $tax->parent==0 )
			{
				...
				if( count($catlist)>0 )
				{
					...
					if( strlen($tax->description) > 0 )
					{
						...
						echo "<p class='padding-bottom-30'>".$tax->description."</p>";

					}
		        
			        echo "<h5 class='fw700 letterspacing2px select-system'>".__( 'SELECCIONA TU SISTEMA', 'swreg' )."</h4>";
					...
					*/
					...
					//Volver a escribir select
						...
						if( strlen($parent->description) > 0 )
						{
							...
							echo "<p class='padding-bottom-30'>".$parent->description."</p>";
						...
						if( count($catlist)>0 )
						{
					        ...
					        echo "<h5 class='fw700 letterspacing2px select-system'>".__( 'SELECCIONA TU SISTEMA bbb', 'swreg' )."</h4>";
						...
						echo "<h3 class='uppercase fw800 colorblack padding-top-30'>".$tax->name."</h3>";
			...
			<div class="row no-margin no-padding background-usosproyectos">
